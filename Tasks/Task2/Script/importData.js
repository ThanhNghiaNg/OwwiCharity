...
// Path to JSON file
const usersFilePath = `${__dirname}/data/json/users.json`;
const partnersFilePath = `${__dirname}/data/json/partners.json`;
const newsFilePath = `${__dirname}/data/json/news.json`;
const projectsFilePath = `${__dirname}/data/json/projects.json`;
const categoriesFilePath = `${__dirname}/data/json/categories.json`;
const transactionsFilePath = `${__dirname}/data/json/transactions.json`;
        ...
        ...(document.images
          ? {
              images: document.images.map((img) => {
                return { ...img, _id: mongoose.Types.ObjectId(img._id.$oid) };
              }),
            }
          : {}),
